      ...
      device.open(function(){
        ...
        printer.align('ct')
              .image(image,'D24').then(()=>{
                printer.font("B")
                printer.size(0.05,0.05)
                printer.text("SERVICIO DRY CLEAN SIX STARS")
                printer.text("TICKET DE PAGO POR SERVICIOS DE TINTORERIA Y LAVADO DE ROPA. ")
                printer.text("CLIENTE A PAGAR: "+nombre_cliente)
